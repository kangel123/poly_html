...
<div style="width:900px">   <!--바깥 공간-->
    ...
    <table cellspacing=3 border=1> <!--신규 공지-->    
        <tr>    <!--1행-->
            ...
            <td style="width:800px;">신규(insert)</td>  <!--2열-->
        </tr>   <!--1행 끝-->
        <tr>    <!--2행-->   
            <th style="width:100px;">제목</th>   <!--1열-->
            <td style="width:800px;"><input type="text" name="title" id="title" maxlength=70 size="100"></td>    <!--2열, 제목-->
        </tr>   <!--2행 종료-->
        <tr>    <!--3행-->   
            <th style="width:100px;">일자</th>   <!--1열-->
            <td style="width:800px;"><input style="border: none; pointer-events: none;" type="text" name="date" value="<%=date%>" tabindex="-1" readonly ></td> <!--2열, 일자-->
        </tr>   <!--3행 종료-->
        <tr>    <!--4행-->   
            <th style="width:100px;">내용</th>   <!--1열-->
            <td style="width:800px;"><textarea name="content" id="content" cols="100" rows="20" style="overflow: auto;resize: none;"></textarea></td>   <!--2열, 내용-->
        </tr>   <!--4행 종료-->   
    </table>    <!--테이블 종료-->
    </div>  <!--1번째 안쪽 공간 끝-->
