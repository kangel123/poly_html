...
<div style="width:900px">   <!--바깥쪽 공간-->
    ...
    <table cellspacing=3 border=1> <!--테이블 시작-->    
        <tr>    <!--1행-->
            ...
            <td style="width:800px;"><input style="border: none; pointer-events: none;" type="text" name="key" value="<%=key%>" tabindex="-1" readonly ></td>  <!--2열--> 
         </tr>   <!--1행 끝-->
        <tr>    <!--2행-->   
            <th style="width:100px;">제목</th>   <!--1열-->
            <td style="width:800px;"><input type="text" name="title" id="title" value="<%=title%>" maxlength=70 size="100">    <!--2열--> 
            </td>    
        </tr>   <!--2행 종료-->
        <tr>    <!--3행-->   
            <th style="width:100px;">일자</th>   <!--1열-->
            <td style="width:800px;"><input style="border: none; pointer-events: none;" type="text" name="date" value="<%=date%>" tabindex="-1" readonly ></td>     <!--2열-->    
        </tr>   <!--3행 종료-->
        <tr>    <!--4행-->   
            <th style="width:100px;">내용</th>   <!--1열-->
            <td style="width:800px;"><textarea name="content" id="content" cols="100" rows="20" style="overflow: auto; resize: none;" ><%=content%></textarea></td> <!--2열-->
        </tr>   <!--4행 종료-->
    ...
    <div style="text-align: right;">    <!--안쪽 공간-->
        ...
        <input type="submit" value="삭제" formaction="./gongji_delete.jsp?key=<%=key%>">    <!--db에 해당 공지 삭제--->
    </div>  <!--안쪽 공간 끝-->
</div>  <!--바깥쪽 공간-->
</form> <!--폼 종료-->
</body>	<!--본문 끝-->
<script>
    var errors = {   // 에러를 묶어놓음
        title: false,  // 기존에 존재하니 제목 에러X
        content: false  // 기존에 존재하니 내용 에러X
    };
