...
<%@ page import="java.sql.*, javax.mail.*, javax.mail.internet.*"%> <!--import 선언-->
...
<head>	<!--머리말 시작-->
	...
	<title>jsp로 import 선언 및 간단한 사용</title>	<!--제목-->    
</head>	<!--머리말 끝-->
<body>	<!--본문-->
    <% String myUrl="http://www.kopo.ac.kr";%>  <!--myUrl(변수) 선언-->
    <a href="<%=myUrl%>">안녕</a> World.   <!--변수의 값에 해당하는 사이트로 이동하는 하이퍼링크 생성, 한글은 깨짐-->
</body>	<!--본문 끝-->
</html>	<!--HTML의 끝-->