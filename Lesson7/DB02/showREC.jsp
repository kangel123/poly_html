...
<% 
    try{
        ...
        if(!id.equals("")){ // 학번을 입력한 경우
            ...
            ResultSet rset = stmt.executeQuery("select *, kor+eng+mat as sum, (kor+eng+mat)/3 as ave,(select count(*)+1 from examtable as m where m.kor+m.eng+m.mat > n.kor+n.eng+n.mat) as ranking from examtable as n where id="+id+";"); // 해당 학번을 찾는 sql문
            while(rset.next()){ // 반복문
...
%>
    ...
    <form method="post">    <!--폼형식:post-->
        <table> <!--테이블 생성-->
            <tr>    <!--1행-->
                <td>이름</td>   <!--1열-->
                <td><input type="text" value="<%=name%>" name="name"  maxlength='20'/></td> <!--2열, 수정 가능, 문자길이 제한-->
            </tr>
            <tr>    <!--2행-->
                <td>학번</td>   <!--1열-->              
            ...
            <tr>    <!--3행-->
                <td>국어</td>   <!--1열-->              
                <td><input type="text" value="<%=kor%>" name="korean" onkeyup=CheckChar(event)></td>    <!--2열, 수정 가능, 숫자 체크-->
            </tr>
            <tr>    <!--4행-->
                <td>영어</td>   <!--1열-->             
                <td><input type="text" value="<%=eng%>" name="english" onkeyup=CheckChar(event)></td>   <!--2열, 수정 가능, 숫자 체크-->
            </tr>
            <tr>    <!--5행-->
                <td>수학</td>   <!--1열-->              
                <td><input type="text" value="<%=mat%>" name="math" onkeyup=CheckChar(event)></td>  <!--2열, 수정 가능, 숫자 체크-->
            </tr>
              <tr>    <!--6행-->
                <td>총점</td>   <!--1열-->                
                <td><input type="text" value="<%=total%>" readonly/></td>  <!--2열, 수정 불가-->
            </tr>
            <tr>    <!--7행-->
                <td>평균</td>   <!--1열-->                
                <td><input type="text" value="<%=average%>" readonly/></td>  <!--2열, 수정 불가-->
            </tr>
            <tr>    <!--8행-->
                <td>등수</td>   <!--1열-->                
                <td><input type="text"value="<%=ranking%>" readonly/></td>  <!--2열, 수정 불가-->
            </tr>
        </table>    <!--테이블 끝-->
