...
<%  try{
        ...
        ResultSet rset = stmt.executeQuery("select *, kor+eng+mat as sum, (kor+eng+mat)/3 as ave,(select count(*)+1 from examtable as m where m.kor+m.eng+m.mat > n.kor+n.eng+n.mat) as ranking from examtable as n where id="+stuid+";"); // 해당 학번의 학생 정보 가져오기
%>
<body>	<!--본문-->
<h1>[<%=stuname%>]조회</h1>   <%--제목--%>
