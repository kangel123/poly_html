...
<div style="width:900px">   <!--바깥쪽 공간-->
    ...
    <div style="text-align: right;">    <!--안쪽 공간-->
        <input type="reset" value="취소" onclick="window.location.href = './gongji_list.jsp'">    
        <input type="submit" value="쓰기" id="submitButton">      
        <input type="submit" value="삭제" formaction="./gongji_delete.jsp?key=<%=key%>">         
    </div>  <!--안쪽 공간 끝-->
</div>  <!--바깥쪽 공간-->
</form>
</body>	<!--본문 끝-->
